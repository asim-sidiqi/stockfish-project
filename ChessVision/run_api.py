...
def process_image():
    ...
    # Lichess URL format: https://lichess.org/analysis/[FEN]
    # FEN needs to be URL encoded (spaces become underscores)
    lichess_fen = fen.replace(' ', '_')
    lichess_url = f"https://lichess.org/analysis/{lichess_fen}"
